...
def create_note(clientID, subject):
	date = datetime.now()
	date = date.date()
	subject = str(subject)
...
def saveMhEducation(request, mh):
	...
	mh.education.FriendshipsKto6 		= request.POST.get('FriendshipsKto6')
	mh.education.Friendships7to9 		= request.POST.get('Friendships7to9')
	mh.education.Friendships10to12		= request.POST.get('Friendships10to12')
...
def saveMhFamily(request, mh):
	mh.familyHistory.isdepressed 			= truePythonBool(request.POST.get('check1'))
	mh.familyHistory.isadd 					= truePythonBool(request.POST.get('check2'))
	mh.familyHistory.isbedWetting 			= truePythonBool(request.POST.get('check3'))
	mh.familyHistory.isbipolar 				= truePythonBool(request.POST.get('check4'))
	mh.familyHistory.issuicideAttempt 		= truePythonBool(request.POST.get('check5'))
	mh.familyHistory.isphysicalAbuse 		= truePythonBool(request.POST.get('check6'))
	mh.familyHistory.islaw 					= truePythonBool(request.POST.get('check7'))
	mh.familyHistory.isld 					= truePythonBool(request.POST.get('check8'))
	mh.familyHistory.istic 					= truePythonBool(request.POST.get('check9'))
	mh.familyHistory.isthyroid 				= truePythonBool(request.POST.get('check10'))
	mh.familyHistory.isheart 				= truePythonBool(request.POST.get('check11'))
	mh.familyHistory.isoverweight 			= truePythonBool(request.POST.get('check12'))
	mh.familyHistory.ismood 				= truePythonBool(request.POST.get('check13'))
	mh.familyHistory.isalcohol 				= truePythonBool(request.POST.get('check14'))
	mh.familyHistory.isdrugs 				= truePythonBool(request.POST.get('check15'))
	mh.familyHistory.isschizo 				= truePythonBool(request.POST.get('check16'))
	mh.familyHistory.isseizures 			= truePythonBool(request.POST.get('check17'))
	mh.familyHistory.iscompletedSuicide 	= truePythonBool(request.POST.get('check18'))
	mh.familyHistory.issexAbuse 			= truePythonBool(request.POST.get('check19'))
	mh.familyHistory.ispanic 				= truePythonBool(request.POST.get('check20'))
	mh.familyHistory.isanxiety 				= truePythonBool(request.POST.get('check21'))
	mh.familyHistory.isOCD 					= truePythonBool(request.POST.get('check22'))
	mh.familyHistory.isdiabetes 			= truePythonBool(request.POST.get('check23'))
	mh.familyHistory.iscancer 				= truePythonBool(request.POST.get('check24'))
	mh.familyHistory.ishighBloodPressure 	= truePythonBool(request.POST.get('check25'))
	mh.familyHistory.isanger 				= truePythonBool(request.POST.get('check26'))
...
def saveMhLegal(request, mh):
	...
	mh.legalHistory.probationPresent = truePythonBool(request.POST.get('m_nowProb'))
	...
	mh.legalHistory.num_suspended = request.POST.get('m_num_suspended')
	mh.legalHistory.suspendedDrivePresent = truePythonBool(request.POST.get('m_currSus'))
	...
	mh.legalHistory.explainPositiveAnswers = request.POST.get('m_positive')
...
def saveMhUse(request, mh):
	mh.useTable.howMuch1 = request.POST.get('m_howMuch1')
	mh.useTable.howMuch2 = request.POST.get('m_howMuch2')
	mh.useTable.howMuch3 = request.POST.get('m_howMuch3')
	mh.useTable.howMuch4 = request.POST.get('m_howMuch4')
	mh.useTable.howMuch5 = request.POST.get('m_howMuch5')
	mh.useTable.howMuch6 = request.POST.get('m_howMuch6')
	mh.useTable.howMuch7 = request.POST.get('m_howMuch7')
	mh.useTable.howMuch8 = request.POST.get('m_howMuch8')
	mh.useTable.howMuch9 = request.POST.get('m_howMuch9')
	mh.useTable.howMuch10 = request.POST.get('m_howMuch10')
	mh.useTable.howMuch11 = request.POST.get('m_howMuch11')
	mh.useTable.howMuch12 = request.POST.get('m_howMuch12')
	mh.useTable.howMuch13 = request.POST.get('m_howMuch13')
	mh.useTable.howMuch14 = request.POST.get('m_howMuch14')
	mh.useTable.howMuch15 = request.POST.get('m_howMuch15')
	mh.useTable.howMuch16 = request.POST.get('m_howMuch16')
	mh.useTable.howMuch17 = request.POST.get('m_howMuch17')
	mh.useTable.howMuch18 = request.POST.get('m_howMuch18')
	mh.useTable.howMuch19 = request.POST.get('m_howMuch19')
	mh.useTable.howMuch20 = request.POST.get('m_howMuch20')
	mh.useTable.howMuch21 = request.POST.get('m_howMuch21')

	mh.useTable.howOften1 = request.POST.get('m_howOften1')
	mh.useTable.howOften2 = request.POST.get('m_howOften2')
	mh.useTable.howOften3 = request.POST.get('m_howOften3')
	mh.useTable.howOften4 = request.POST.get('m_howOften4')
	mh.useTable.howOften5 = request.POST.get('m_howOften5')
	mh.useTable.howOften6 = request.POST.get('m_howOften6')
	mh.useTable.howOften7 = request.POST.get('m_howOften7')
	mh.useTable.howOften8 = request.POST.get('m_howOften8')
	mh.useTable.howOften9 = request.POST.get('m_howOften9')
	mh.useTable.howOften10 = request.POST.get('m_howOften10')
	mh.useTable.howOften11 = request.POST.get('m_howOften11')
	mh.useTable.howOften12 = request.POST.get('m_howOften12')
	mh.useTable.howOften13 = request.POST.get('m_howOften13')
	mh.useTable.howOften14 = request.POST.get('m_howOften14')
	mh.useTable.howOften15 = request.POST.get('m_howOften15')
	mh.useTable.howOften16 = request.POST.get('m_howOften16')
	mh.useTable.howOften17 = request.POST.get('m_howOften17')
	mh.useTable.howOften18 = request.POST.get('m_howOften18')
	mh.useTable.howOften19 = request.POST.get('m_howOften19')
	mh.useTable.howOften20 = request.POST.get('m_howOften20')
	mh.useTable.howOften21 = request.POST.get('m_howOften21')

	mh.useTable.howLong1 = request.POST.get('m_howLong1')
	mh.useTable.howLong2 = request.POST.get('m_howLong2')
	mh.useTable.howLong3 = request.POST.get('m_howLong3')
	mh.useTable.howLong4 = request.POST.get('m_howLong4')
	mh.useTable.howLong5 = request.POST.get('m_howLong5')
	mh.useTable.howLong6 = request.POST.get('m_howLong6')
	mh.useTable.howLong7 = request.POST.get('m_howLong7')
	mh.useTable.howLong8 = request.POST.get('m_howLong8')
	mh.useTable.howLong9 = request.POST.get('m_howLong9')
	mh.useTable.howLong10 = request.POST.get('m_howLong10')
	mh.useTable.howLong11 = request.POST.get('m_howLong11')
	mh.useTable.howLong12 = request.POST.get('m_howLong12')
	mh.useTable.howLong13 = request.POST.get('m_howLong13')
	mh.useTable.howLong14 = request.POST.get('m_howLong14')
	mh.useTable.howLong15 = request.POST.get('m_howLong15')
	mh.useTable.howLong16 = request.POST.get('m_howLong16')
	mh.useTable.howLong17 = request.POST.get('m_howLong17')
	mh.useTable.howLong18 = request.POST.get('m_howLong18')
	mh.useTable.howLong19 = request.POST.get('m_howLong19')
	mh.useTable.howLong20 = request.POST.get('m_howLong20')
	mh.useTable.howLong21 = request.POST.get('m_howLong21')

	mh.useTable.howOld1 = request.POST.get('m_howOld1')
	mh.useTable.howOld2 = request.POST.get('m_howOld2')
	mh.useTable.howOld3 = request.POST.get('m_howOld3')
	mh.useTable.howOld4 = request.POST.get('m_howOld4')
	mh.useTable.howOld5 = request.POST.get('m_howOld5')
	mh.useTable.howOld6 = request.POST.get('m_howOld6')
	mh.useTable.howOld7 = request.POST.get('m_howOld7')
	mh.useTable.howOld8 = request.POST.get('m_howOld8')
	mh.useTable.howOld9 = request.POST.get('m_howOld9')
	mh.useTable.howOld10 = request.POST.get('m_howOld10')
	mh.useTable.howOld11 = request.POST.get('m_howOld11')
	mh.useTable.howOld12 = request.POST.get('m_howOld12')
	mh.useTable.howOld13 = request.POST.get('m_howOld13')
	mh.useTable.howOld14 = request.POST.get('m_howOld14')
	mh.useTable.howOld15 = request.POST.get('m_howOld15')
	mh.useTable.howOld16 = request.POST.get('m_howOld16')
	mh.useTable.howOld17 = request.POST.get('m_howOld17')
	mh.useTable.howOld18 = request.POST.get('m_howOld18')
	mh.useTable.howOld19 = request.POST.get('m_howOld19')
	mh.useTable.howOld20 = request.POST.get('m_howOld20')
	mh.useTable.howOld21 = request.POST.get('m_howOld21')

	mh.useTable.lastTime1 = request.POST.get('m_lastTime1')
	mh.useTable.lastTime2 = request.POST.get('m_lastTime2')
	mh.useTable.lastTime3 = request.POST.get('m_lastTime3')
	mh.useTable.lastTime4 = request.POST.get('m_lastTime4')
	mh.useTable.lastTime5 = request.POST.get('m_lastTime5')
	mh.useTable.lastTime6 = request.POST.get('m_lastTime6')
	mh.useTable.lastTime7 = request.POST.get('m_lastTime7')
	mh.useTable.lastTime8 = request.POST.get('m_lastTime8')
	mh.useTable.lastTime9 = request.POST.get('m_lastTime9')
	mh.useTable.lastTime10 = request.POST.get('m_lastTime10')
	mh.useTable.lastTime11 = request.POST.get('m_lastTime11')
	mh.useTable.lastTime12 = request.POST.get('m_lastTime12')
	mh.useTable.lastTime13 = request.POST.get('m_lastTime13')
	mh.useTable.lastTime14 = request.POST.get('m_lastTime14')
	mh.useTable.lastTime15 = request.POST.get('m_lastTime15')
	mh.useTable.lastTime16 = request.POST.get('m_lastTime16')
	mh.useTable.lastTime17 = request.POST.get('m_lastTime17')
	mh.useTable.lastTime18 = request.POST.get('m_lastTime18')
	mh.useTable.lastTime19 = request.POST.get('m_lastTime19')
	mh.useTable.lastTime20 = request.POST.get('m_lastTime20')
	mh.useTable.lastTime21 = request.POST.get('m_lastTime21')
